/**
 ******************************************************************************
 * @file      startup_stm32l1xx_md.c
 * @author    Coocox
 * @version   V1.0
 * @date      11/13/2011
 * @brief     STM32L1xx Medium Density Devices Startup code.
...
void WEAK  USB_HP_TX_IRQHandler(void);
void WEAK  USB_LP_RX_IRQHandler(void);
...
void (* const g_pfnVectors[])(void) =
{
  ...
  TAMPER_STAMP_IRQHandler,      /*!<  2: Tamper                               */
  RTC_WKUP_IRQHandler,          /*!<  3: RTC                                  */
  ...
  USB_HP_TX_IRQHandler,    		/*!< 19: USB High Priority TX         		  */
  USB_LP_RX_IRQHandler,   		/*!< 20: USB Low  Priority RX        		  */
  DAC_IRQHandler,          		/*!< 21: DAC                             	  */
  COMP_IRQHandler,          	/*!< 22: COMP                             	  */
  ...
  USB_FS_WKUP_IRQHandler,       /*!< 42: USB Wakeup from suspend              */
  TIM6_IRQHandler,				/*!< 43: TIM6                          		  */
  TIM7_IRQHandler,				/*!< 44: TIM7                          		  */
  0,0,0,0,0,                	/*!< Reserved                                 */
...
#pragma weak USB_HP_TX_IRQHandler = Default_Handler
#pragma weak USB_LP_RX_IRQHandler = Default_Handler
